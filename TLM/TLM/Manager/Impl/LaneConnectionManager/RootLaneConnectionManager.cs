namespace TrafficManager.Manager.Impl.LaneConnectionManager {
    ...
    public class RootLaneConnectionManager
        ...
        static RootLaneConnectionManager() {
            Instance = new RootLaneConnectionManager();
        }

        public static RootLaneConnectionManager Instance { get; }
